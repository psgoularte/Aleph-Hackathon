      ...
      <main className="flex-1 container py-8">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-start gap-6 mb-8">
            ...
            <Button className="bg-white text-black border-2 border-gray-300 hover:bg-gray-100 hover:border-[#06B6D4] focus:ring-2 focus:ring-[#06B6D4] transition-all duration-200">
              Edit Profile
            </Button>
          </div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between items-center py-2 border-b">
                        ...
                        <Badge className="bg-[#06B6D4] text-black">0.08 ETH</Badge>
                      </div>
                      <div className="flex justify-between items-center py-2 border-b">
                        <div>
                        ...
                        <Badge className="bg-[#06B6D4] text-black">0.1 ETH</Badge>
                      </div>
                    </div>
                  </CardContent>
                </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-6">
                    ...
                    <Button className="w-full bg-white text-black border-2 border-gray-300 hover:bg-gray-100 hover:border-[#06B6D4] focus:ring-2 focus:ring-[#06B6D4] transition-all duration-200">
                      Withdraw Funds
                    </Button>
                  </div>
                </CardContent>
